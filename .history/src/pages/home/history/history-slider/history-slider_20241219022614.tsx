      ...
      <Swiper
        ...
        breakpoints={{
          1200: {
            spaceBetween: 80,
            slidesPerView: 3.5,
            pagination: { clickable: true }, // Точки включаются при разрешении 1200px
          },
          768: {
            slidesPerView: 2.5,
            spaceBetween: 25,
            pagination: { clickable: true }, // Точки включаются при разрешении 768px
          },
          0: {
            pagination: false, // Точки выключаются для разрешений меньше 768px
          },
        }}
      >
