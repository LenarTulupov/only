...
export default function HistorySlider({ className, activeCategory }: IHistorySlider) {
  ...
  useEffect(() => {
    ...
    // Сбросить слайдер на начало, если swiper инициализирован
    if (swiperRef.current) {
      swiperRef.current.slideTo(0); // Сбросить слайдер на первый слайд
    }
  }, [activeCategory]); // Отслеживаем изменение activeCategory
