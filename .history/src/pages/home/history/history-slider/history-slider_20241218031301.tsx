    ...
    >
      <ContentContainer>
        <Swiper
          ...
          onTransitionStart={() => gsap.to(containerRef.current, { opacity: 0, y: -20, duration: 0.5, ease: "power2.in" })}
          onTransitionEnd={() => gsap.fromTo(containerRef.current, { opacity: 0, y: 20 }, { opacity: 1, y: 0, duration: 0.5, ease: "power2.out" })}
        >
