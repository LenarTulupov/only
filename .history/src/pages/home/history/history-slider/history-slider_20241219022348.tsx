  ...
  return (
    ...
    >
      <Swiper
        spaceBetween={40}
        slidesPerView={1.5}
        modules={[Navigation, Pagination]} // Подключаем Pagination
        pagination={{ clickable: true }} // Включаем кликабельные точки
        onSwiper={(swiper) => {
        ...
        breakpoints={{
          ...
          768: {
            slidesPerView: 2.5,
            spaceBetween: 25,
            pagination: { clickable: true }, // Точки включаются с 768px
          },
        }}
      >
